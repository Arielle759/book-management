...
public class BookRepository {
    ...
    public List<Book> listeBooksByCategory(String categoryName) {
        return em
                .createQuery(
                        "SELECT b FROM Book b WHERE LOWER(b.category.name) = :catName ORDER BY b.title ASC",
                        Book.class)
    ...
    public List<Book> searchBooksByTitle(String keyword) {
        return em
                .createQuery(
                        "SELECT b FROM Book b WHERE LOWER(b.title) LIKE :kw ORDER BY b.title ASC",
                        Book.class)
    ...
    public List<Book> searchBooksByAuthor(String keyword) {
        return em
                .createQuery(
                        "SELECT b FROM Book b WHERE LOWER(b.author) LIKE :kw ORDER BY b.author ASC",
                        Book.class)
                .setParameter("kw", "%" + keyword.toLowerCase() + "%")
                .getResultList();
    }
    ...
    public long countBooksByCategory() {
        return em
                .createQuery("SELECT COUNT(b.id) FROM Book b GROUP BY b.category.name", Long.class)
                .getResultList()
                .size();
    }
